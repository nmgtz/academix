...
function toggleForms(action) {
  // Map the action to the form container ID
  ...
  if (!formContainerId) {
    console.error(`Invalid action: "${action}". No corresponding form container ID found.`);
    return;
  }
  ...
  // Adjust visibility of the login form container specifically
