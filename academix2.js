...
function toggleForms(formId1) {
  ...
  // Show the form corresponding to formId
  const formToShow = document.getElementById(formId1);
  formToShow.classList.add("active");
  formToShow.style.display = "block"; // Show the form

  // Adjust visibility of the login form based on the form being toggled
  const lgForm = document.getElementById("lg-form");
  lgForm.style.display = (formId1 === "sp-form" || formId1 === "set-form") ? "none" : "block";
}
